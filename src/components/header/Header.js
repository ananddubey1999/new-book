            ...
            >
                <div className="headerList">
                    ...
                    <div className="headerListItem active">
                        ...
                        <Link to="/Flight+Hotel"> <span style={{ "color": "cyan" }}>Flight+Hotel</span></Link>
                    </div>
                    <div className="headerListItem active">
                        <FontAwesomeIcon icon={faCar} />
                        <Link to="/Car rentals"> <span style={{ "color": "cyan" }}>Car rentals</span></Link>
                    </div>
                    <div className="headerListItem active">
                        <FontAwesomeIcon icon={faTaxi} />
                        <Link to="/Airport taxis"> <span style={{ "color": "cyan" }}>Airport taxis</span></Link>
                    </div>
                </div>
                {type !== "list" && (
                    <>
